      ...
      <article>
        <section className="container mb-8">
          ...
          <p className="leading-7 mb-8">
            ...
            currently works as a Full-Stack python developer. I have a
            Theoretical knowledge of the fundamentals HTML, CSS and JS. Formely
            specialised in react development, until switching to nuxt and
            vue.js. My tech stack is django-rest, nuxt, vue and tailwind for
            styling as well as contributing with the WordPress team.
          </p>
        </section>
        <section className="container">
          ...
          <div className="mb-4 flex items-center bg-badge p-3 rounded border border-grey">
            <p className="text-sm leading-7">
              <span className="mr-1 lg:mr-4">⚡</span> React, Next, Vue, Nuxt,
